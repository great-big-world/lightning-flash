    ...
    public void onInitializeClient() {
        ClientPlayNetworking.registerGlobalReceiver(StruckByLightningS2C.PACKET_ID, (struckByLightningS2C, context) -> {
            ...
            context.client().execute(() -> {
                ...
                if (entity instanceof ExtendedEntity extendedEntity && !(entity.typeHolder().is(LightningFlash.CANNOT_LIGHTNING_FLASH))) {
                    extendedEntity.gbw$setStruckByLightningTime(10);
                }
            });
        });
    }
