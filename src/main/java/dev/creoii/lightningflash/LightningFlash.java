...
public class LightningFlash implements ModInitializer {
    ...
    public static final TagKey<EntityType<?>> CANNOT_LIGHTNING_FLASH = TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath("great_big_world", "cannot_lightning_flash"));
